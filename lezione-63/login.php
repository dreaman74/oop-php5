...
<body>
    ...
    <p>La spiegazione di questo script (login.php) e quello a cui l'action del form rimanda (elogin.php) è riportata nella Lezione 63.</p>
    ...
    if( isset($_GET['errore']) ){
        echo "<p id='box_errore'".
            ...
            */
            ...
            // Chiave Recuperata dal File.INI 'messaggi_errore.ini' in my_ini
