...
<body>
    <p id="breadcrumb">
        <a href="../index.php" title="indice delle lezioni">Indice</a> / <a href="../lezione-57-forms-e-dbms-6.php" title="lezione 57">Lezione 57</a> / login.php
    </p>

    <h1>Form di Login - login.php</h1>
    <p>La spiegazione di questo script (login.php) e quello a cui l'action del form rimanda (elogin.php) è riportata nella Lezione 57.</p>
